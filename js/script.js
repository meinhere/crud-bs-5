$(document).ready(function () {
  ...
  $('.btn-ubah').on('click', function () {
    ...
    if (id) {
      ...
      $('.modal-body p').html('Masukkan password terlebih dahulu jika ingin mengedit data seorang Administrator');
      ...
      if (labelHidden != 'ubah') {
        ...
        $('#row .passwordLabel').append("<label for='password' class='col-form-label'>Password</label>");
        $('#row .inputPassword').append("<input type='password' name='password' id='password' class='form-control' placeholder='Masukkan password' required>");
  ...
  $('.btn-login').on('click', function () {
    ...
    if (labelHidden != 'login') {
      ...
      $('#row .usernameLabel').append("<label for='username' class='col-form-label'>Username</label>");
      $('#row .inputUsername').append("<input type='text' name='username' id='username' class='form-control' placeholder='Masukkan username' required>");
